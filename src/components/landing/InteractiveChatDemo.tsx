            ...
            <div className="flex lg:hidden gap-2">
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${
                  activeTab === "tasks" ? "bg-primary text-primary-foreground" : "glass text-muted-foreground"
                }`}
              >
              ...
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${
                  activeTab === "insights" ? "bg-primary text-primary-foreground" : "glass text-muted-foreground"
                }`}
              >
